...
namespace UniLib {
	...
	namespace controller {
		class UNIVERSUMLIB_EXPORT BindToRenderer
		{
		public: 
			...
			virtual view::BlockSector* newBlockSector() = 0;
			...
			virtual view::Geometrie* newGeometrie(std::shared_ptr<model::geometrie::BaseGeometrie> baseGeometrie) = 0;

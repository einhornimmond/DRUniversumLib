...
namespace UniLib {
	...
	namespace model {
		...
		class UNIVERSUMLIB_EXPORT BlockSector : public Sector
		{
		public:
			BlockSector(Node* parent, model::SectorID* id, view::BlockSector* viewSector);
			virtual ~BlockSector();
			...
			virtual const char* getSectorType() {return "BlockSector";}

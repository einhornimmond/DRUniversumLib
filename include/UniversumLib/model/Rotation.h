...
namespace UniLib {
	namespace model {
		...
		class UNIVERSUMLIB_EXPORT Rotation
		{
		public:
			...
			inline const DRVector3& getYAxis() const {return mYAxis;}
			inline DRVector3 getYAxis() {return mYAxis;}
			inline const DRVector3& getXAxis() const {return mXAxis;}
			inline DRVector3 getXAxis() {return mXAxis;}
			inline const DRVector3& getZAxis() const {return mZAxis;}
			inline DRVector3 getZAxis() {return mZAxis;}

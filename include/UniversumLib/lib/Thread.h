...
namespace UniLib {
    namespace lib {
        ...
        public:
            ...
            inline DRReturn threadLock() {if(SDL_LockMutex(mutex)) LOG_ERROR_SDL(DR_ERROR); return DR_OK;}
            inline DRReturn threadUnlock() {if(SDL_UnlockMutex(mutex)) LOG_ERROR_SDL(DR_ERROR); return DR_OK;} 

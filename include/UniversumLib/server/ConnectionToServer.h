...
namespace UniLib {
    ...
    namespace server {
        ...
        public:
			...
			// inline check state
            inline bool isConnectionValid()  {return mConnectionNumber >= 0;}
            inline bool isInitalized() {return mInitalized;}

			// getter and setter for network tasks
			inline u16 getConnectionNumber() {return mConnectionNumber;}
			inline GetPublicKeyNetworkTask* getPublickKeyTask() { return mPublicKeyRequestTask;}
			inline lib::Crypto* getRSAModule() {return mRSAModule;}
			inline DRNetServerConfig getServerConfig() {return mServerConfig;}
